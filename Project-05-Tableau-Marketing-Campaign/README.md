...
**Age Group Spending Analysis (Stacked Bar)**
...
## 📂 Files
- `Marketing_Campaign_Analysis.twbx` - Tableau workbook
...
1. **Target Golden Segment:** Focus marketing spend on Graduation + High Income
2. **Channel Strategy:** Prioritize in-store experience while optimizing web
3. **Product Focus:** Leverage Wine category dominance for cross-selling
4. **Age Targeting:** Develop premium offerings for 60+ demographic
5. **Cost Optimization:** Reduce investment in low-performing segments
